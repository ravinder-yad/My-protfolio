      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-textMain dark:text-white mb-8 leading-tight">
            ...
            <p className="text-lg md:text-xl text-textGray dark:text-slate-400 leading-relaxed mb-6">
            ...
            <p className="text-lg md:text-xl text-textGray dark:text-slate-400 leading-relaxed">
