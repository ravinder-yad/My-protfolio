...
const Contact = () => {
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen bg-white font-sans text-gray-800">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            <div className="bg-gray-50 border border-gray-100 p-10 rounded-3xl h-full flex flex-col justify-between relative overflow-hidden shadow-sm">
              ...
              <div className="relative z-10 mt-12 pt-8 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  <a href={socialLinks.linkedin} target="_blank" rel="noreferrer" className="w-10 h-10 bg-white border border-gray-200 text-gray-600 hover:bg-blue-600 hover:border-blue-600 hover:text-white rounded-full flex items-center justify-center transition-all shadow-sm">
                    <FaLinkedin />
                  </a>
                  <a href={socialLinks.github} target="_blank" rel="noreferrer" className="w-10 h-10 bg-white border border-gray-200 text-gray-600 hover:bg-gray-900 hover:border-gray-900 hover:text-white rounded-full flex items-center justify-center transition-all shadow-sm">
                    <FaGithub />
                  </a>
                </div>
              </div>
          ...
          >
            <div className="bg-white p-10 md:p-12 rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-xl transition-shadow h-full flex flex-col justify-center">
